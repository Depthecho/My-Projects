...
class RegistrationForm(forms.ModelForm):
    username = forms.CharField(
        ...
        help_text='',
        max_length=25,
        widget=forms.TextInput(attrs={'class': 'help-text', 'id': 'username-input'}),
    )
    ...
    class Meta:
        ...
        widgets = {
            'username': forms.TextInput(attrs={'class': 'signup-username'}),
            'email': forms.EmailInput(attrs={'class': 'signup-email'}),
        }
